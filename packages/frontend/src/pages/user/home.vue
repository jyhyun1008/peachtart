			...
			<div class="profile _gaps">
				...
				<div :key="user.id" class="main _panel">
					...
					<div v-if="user.fields.length > 0" class="fields">
						<ul class="field">
							<li v-for="(field, i) in user.fields.filter((f) => f.name.includes('![') && f.name.includes(']('))" :key="i" >
								<a :href="field.value">
						...
						<dl v-for="(field, i) in user.fields" :key="i" class="field">
							<dt v-if="!field.name.includes('![') && !field.name.includes('](')" class="name">
								<Mfm :text="field.name" :author="user" :plain="true" :colored="false"/>
							</dt>
							<dd v-if="!field.name.includes('![') && !field.name.includes('](')" class="value">
